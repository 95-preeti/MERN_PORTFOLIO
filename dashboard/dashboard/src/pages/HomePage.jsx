...
import { FolderGit, History, Home, LayoutGrid, LogOut, MessageSquareMore, Package, Package2, PanelLeftIcon, PencilRuler, User, User2 } from 'lucide-react';
...
import AddMessages from './sub-components/AddMessages';
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
                  ...
                  onClick={() => setActive("Add Messages ")}
                >
                  <MessageSquareMore className="h-5 w-5" />
                  <span className="sr-only">Add Messages</span>
                </Link>
              </TooltipTrigger>
              <TooltipContent side="right">Add Messages</TooltipContent>
            </Tooltip>
          </TooltipProvider>
